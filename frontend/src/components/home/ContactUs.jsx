...
const ContactUs = () => {
    ...
    return (
        <div>
            {/* Contact Us Section */}
            <div id="contact" className="bg-contact-us-background min-h-screen font-montserrat flex items-center justify-center bg-cover bg-center px-4">
                <div className="flex flex-col md:flex-row bg-white bg-opacity-80 rounded-lg shadow-lg p-8 md:p-16 max-w-4xl w-full">
                    ...
                    <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <button
                                type="submit"
                                className="w-full text-white font-bold px-3 py-2 rounded-lg bg-dark-pastel-orange hover:bg-dark-grayish-orange transition duration-300"
                            >
                                Send Message
                            </button>
                        </form>
