...
export default function Camera() {
    ...
    const [piCameraUrl, setPiCameraUrl] = useState('https://raspberrypi.tail58fb54.ts.net/video_feed');
    
    // Pi control endpoints
    const piControlUrl = 'https://raspberrypi.tail58fb54.ts.net';
    ...
    const retryCamera = () => {
        ...
        setPiCameraUrl(`https://raspberrypi.tail58fb54.ts.net/video_feed?cache=${Date.now()}`);
    };
