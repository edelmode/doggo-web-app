...
export default function Camera() {
    ...
    const [piCameraUrl, setPiCameraUrl] = useState('https://raspberrypi.tail58fb54.ts.net:5000/video_feed');
    
    // Pi control endpoints
    const piControlUrl = 'https://raspberrypi.tail58fb54.ts.net:5000';
    ...
    const retryCamera = () => {
        ...
        setPiCameraUrl(`https://raspberrypi.tail58fb54.ts.net:5000/video_feed?cache=${Date.now()}`);
    };
