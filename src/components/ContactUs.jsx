...
const ContactUs = () => {
    ...
    return (
        <div>
            {/* Contact Us Section */}
            <div id="contact" className="min-h-screen flex items-center justify-center bg-cover bg-center px-4" style={{ backgroundImage: "url('/public/contactBG.png')" }}>
                <div className="flex flex-col md:flex-row bg-white bg-opacity-80 rounded-lg shadow-lg p-8 md:p-16 max-w-4xl w-full">
                    ...
                    <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
                        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center" style={{ color: '#7A6251', fontFamily: 'Akshar' }}>
                            Contact Us
                        </h2>
                    ...
                    <div className="md:w-1/2 text-center md:text-left mt-100 md:mt-0">
                        <h3 className="text-3xl md:text-4xl font-bold mb-10 text-center" style={{ color: '#7A6251', fontFamily: 'Akshar' }}>
                            Get in Touch
                        </h3>
