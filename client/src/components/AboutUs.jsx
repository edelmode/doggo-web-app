...
const AboutUs = () => {
    return (
        ...
        >
            {/* Heading */}
            <h2
                className="text-3xl md:text-4xl font-bold mb-8 absolute top-[80px] text-[#7A6251] font-akshar"
            >
                About DOGGO
            </h2>
            ...
            <div className="flex items-center mt-24">
                ...
                <div className="flex items-center bg-white bg-opacity-80 rounded-lg p-4 md:p-6 shadow-lg">
                    {/* Image on the left */}
                    <img
                        src="/assets/dog.jpg" // Replace with the actual image path
                        alt="Dog"
            ...
            <div className="flex flex-wrap justify-center space-x-3 mt-10 max-w-screen-2xl w-full">
                ...
                <div className="bg-white bg-opacity-80 rounded-lg p-4 md:p-6 shadow-lg mt-2 max-w-xs w-full flex-grow">
                    <h3 className="text-lg md:text-4xl font-bold mb-4 text-[#7A6251] font-akshar">Mission</h3>
                ...
                {/* Vision Section */}
                <div className="bg-white bg-opacity-80 rounded-lg p-4 md:p-6 shadow-lg mt-2 max-w-xs w-full flex-grow">
                    <h3 className="text-xl md:text-4xl font-bold mb-4 text-[#7A6251] font-akshar">Vision</h3>
                ...
                <div className="bg-white bg-opacity-80 rounded-lg p-4 md:p-6 shadow-lg mt-2 max-w-xs w-full flex-grow">
                    <h3 className="text-xl md:text-2xl font-bold mb-4 text-[#7A6251] font-akshar">How it Works</h3>
                    <p className="text-base md:text-lg leading-relaxed">
                ...
                <div className="bg-white bg-opacity-80 rounded-lg p-4 md:p-6 shadow-lg mt-2 max-w-xs w-full flex-grow">
                    <h3 className="text-xl md:text-2xl font-bold mb-4 text-[#7A6251] font-akshar">Technology Behind DOGGO</h3>
                    <p className="text-base md:text-lg leading-relaxed">
