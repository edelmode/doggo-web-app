        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div className='md:ml-10'>
            ...
            <div className="flex justify-center md:justify-start space-x-4">
              <a href="https://facebook.com" className="hover:text-gray-400 hover:transition duration-300 text-3xl">
                <i className="fab fa-facebook-f"></i>
              </a>
              <a href="https://instagram.com" className="hover:text-gray-400 hover:transition duration-300 text-3xl">
                <i className="fab fa-instagram"></i>
              </a>
              <a href="https://twitter.com" className="hover:text-gray-400 hover:transition duration-300 text-3xl">
