...
import FetchingOverviewModal from './FetchingOverviewModal';
...
export default function FetchingHome() {
    ...
    return (
        <div className="h-screen flex flex-col items-center justify-center bg-bg p-5">
            {isOverviewOpen && 
            ...
            <button 
                className="text-md font-lg text-white rounded-full bg-doggo px-3 py-2 hover:bg-yellow transition duration-300">
                Start Fetching
            </button>
        </div>
    );
